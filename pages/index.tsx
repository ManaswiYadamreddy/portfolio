    ...
    <Layout>
      <PageSection color={color}>
        <PageWrapper>
          <article>
            <motion.h1
              data-text="Manaswi Yadamreddy"
              className="intro__text"
              {...getTransitions(0.1)}
            >
              <mark className="mark">Manaswi Yadamreddy</mark>
            </motion.h1>
            <motion.p {...getTransitions(0.3)}>
              {' '}
              I’m currently a Master’s student in Artificial Intelligence at 
              Boston University, with a background in Engineering Physics from IIT Guwahati. 
              I love working on real-world AI problems and finding creative ways to apply 
              machine learning to complex challenges. I’m especially drawn to projects 
              that have real impact, whether it’s in healthcare, accessibility, or 
              just making everyday systems smarter. I'm always curious, always learning, 
          ...
          <motion.div {...getTransitions(0.7)}>
            <FooterLink goto="/experience">View My Experience</FooterLink>
          </motion.div>
